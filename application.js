...
define(["require", "exports", 'express', 'lodash'], function(require, exports, express, _) {
    var App = (function () {
        function App() {
            this.routes = {
                '/': function (req, res) {
        ...
        App.prototype.start = function () {
            ...
            io.on('connection', function (socket) {
                ...
                sockets.push(socket);
                socket.emit('news', '<h2>welcome, you can change your display name at the left-bottom</h2>');
